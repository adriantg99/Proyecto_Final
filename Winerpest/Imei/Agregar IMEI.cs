...
namespace Winerpest.Imei
{
    public partial class Agregar_IMEI : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'winnerPetDataSet3.GPS' Puede moverla o quitarla según sea necesario.
            this.gPSTableAdapter.Fill(this.winnerPetDataSet3.GPS);
